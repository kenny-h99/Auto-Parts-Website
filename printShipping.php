...
<!----------------- IMPLEMENTING THE PRINT SHIPPING LABEL CODE HERE --------------------------->
<body>
...
<?php
    ...
    {
	echo"<div id='printableArea' style=\"border: 5px black; border-style:solid; background-color: white; width: 300px;\">";

	$OrderNum = $_GET["OrderNumber"];
        $sql = "SELECT users.Name, users.Address FROM users JOIN orders ON users.userID=orders.CustomerID WHERE orders.OrderID = ?";
	...
	if ($result->rowCount() > 0)
	{
		...
		echo "<p style=\"font-size: 8px; color: black;\">Dream Team Auto Parts<br>";
		echo "400 Dream Way<br>";
		echo "Dream Land, IL 12345<br></p>";
		echo "<p style=\"font-size: 15px; color: black;\">Ship To: <br>";
		...
		echo "<img class='same-size-images' src='images/Shipping.png' alt='Shipping Label Image'>";	
		echo"</div>";
...
newwin.document.write('<TITLE>Shipping Labels</TITLE>\n')
...
<input type="submit" name="newOrderNumber" formaction="printShipping.php" value="View New Order Number">
<br> <br>
